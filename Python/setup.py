...
argparser.add_argument(
    ...
    type=str,
    default=None,
    help="Install libwarpx with the given value as DIM. This option is only used by the GNU makefile build system.",
)
argparser.add_argument(
    "--with-lib-dir",
    type=str,
    default=None,
    help="Install with all libwarpx* binaries found in a directory.",
)
